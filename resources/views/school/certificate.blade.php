...
<div class="container-fluid px-0" style="height: 500px">
    <div style="position: relative;text-align: center"
         ...
         <!-- <img class="" style="position: absolute; margin-top: 450px" width="400" height="180" src="{{$data['logo']}}"> -->
         <img class="" style="position: absolute; margin-top: 450px" width="400" height="180" src="{{env('APP_URL').'/school/logos/1634151809-logoschoolbranco.png'}}">

        <div style="margin-top: 480px" class="col-12 text-block align-self-center">
            ...
            <p  style="word-wrap: break-word;white-space: nowrap">on <span class="font-weight-bold" style="font-family: DejaVu Sans;">VG School</span> online course on <span class="font-weight-bold">{{$data['date']}}</span></p>
        </div>

        <!-- <img width="100%" src="{{$data['certificate']}}"> -->
        <img width="100%" src="{{env('APP_URL').'/school/certificates/certificate.jpg'}}">
    </div>
</div>
</body>
</html>
